-- Fix and Apply Continuous Aggregates for Candle Generation
-- This script creates candle continuous aggregates using the correct function names

-- Ensure TimescaleDB Toolkit is installed
CREATE EXTENSION IF NOT EXISTS timescaledb_toolkit;

-- Create 1-minute candles using candlestick_agg (from public schema)
...
-- Refresh continuous aggregates to backfill historical data
